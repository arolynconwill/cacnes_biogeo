function make_prob_plots_low( prob_in_pore_mat, ...
...
% Y axis
ylabel('probability in pore after t_{g}')
yticks( [ (10^min_prob_to_show)^2 (10^min_prob_to_show) 1 ])
yticklabels( { [ '<10^{' num2str(2*min_prob_to_show) '}' ], [ '10^{' num2str(min_prob_to_show) '}' ], '10^0' } )
...
print( [ dir_figs '/' 'fig_probs_vary-D-tgen_low.png' ],'-dpng')
...
print( [ dir_figs '/' 'fig_probs_vary-v-tgen_low.png' ],'-dpng')
