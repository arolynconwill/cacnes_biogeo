function plot_sampleset_mafs_v2_morepos( mySamplesetMAFs, p_important, p_all, plotSampleNames, plotSampleOrder, mySamplesetName, cluster_filtering_directory_name )
