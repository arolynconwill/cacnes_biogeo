function plot_sampleset_coverage( mySamplesetCoverage, p_important, p_all, plotSampleNames, plotSampleOrder, mySamplesetName, cluster_filtering_directory_name )
...
figure(1)
clf(1,'reset')
figCov=heatmap(xvalues, yvalues,mySamplesetCoverageNormalizedImportantPositions(plotSampleOrder,pos_min:pos_skip:pos_max));
% Color scheme
myColormap = flipud(hot(20));
