function combine_positions_snakemake( path_to_list_of_input_p_files, path_to_other_p_file, path_to_output_p_file, REF_GENOME_DIRECTORY, looseFQmax )
...
cp = generate_positions_snakemake( paths_to_input_p_files, REF_GENOME_DIRECTORY );
